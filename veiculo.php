...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-sm-8">
            ...
            <button type="button" class="btn btn-primary" onclick="window.location.href='addVeiculo.php'">Novo</button><br>
            <?php
        ...
        <div class="col-sm-4" id="teste">
            <h3><svg class="bi bi-cone text-danger" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><path d="M7.03 1.88c.252-1.01 1.688-1.01 1.94 0L12 14H4L7.03 1.88z"/><path fill-rule="evenodd" d="M1.5 14a.5.5 0 01.5-.5h12a.5.5 0 010 1H2a.5.5 0 01-.5-.5z" clip-rule="evenodd"/></svg> Veículos Inativos:</h3>
            <?php
            $r = $db->query("SELECT * FROM veiculo WHERE ativo=0 ORDER BY placa DESC");
            $linhas = $r->fetchAll(PDO::FETCH_ASSOC);
            foreach($linhas as $l) {
                echo "
                    <br>
