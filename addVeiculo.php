        ...
        <div class="col-sm-12">
            ...
            <form action="addVeiculo.php" method="post">
                <div class="form-group">
                    <input type="text" class="form-control" required name="placa" placeholder="Placa" minlength="7" maxlength="7" id="inputVerde">
                </div>
                <div class="form-group">
                    <input type="text" class="form-control" required name="modelo" placeholder="Modelo" maxlength="100" id="inputVerde">
                </div>
                <div class="form-group">
                    <input type="number" step="0.01" class="form-control" required name="quilometragem" placeholder="Quilometragem(Km)" min=0 max=9999999 id="inputVerde">
                </div>
                <div class="form-group">
                    <label for="selectCpf">Cpf Proprietário</label>
                    <select class="form-control" id="inputVerde" required name="cpf">
                        <?php
