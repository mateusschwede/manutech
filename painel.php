...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-sm-12">
            <h3><svg class="bi bi-wrench" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M.102 2.223A3.004 3.004 0 003.78 5.897l6.341 6.252A3.003 3.003 0 0013 16a3 3 0 10-.851-5.878L5.897 3.781A3.004 3.004 0 002.223.1l2.141 2.142L4 4l-1.757.364L.102 2.223zm13.37 9.019L13 11l-.471.242-.529.026-.287.445-.445.287-.026.529L11 13l.242.471.026.529.445.287.287.445.529.026L13 15l.471-.242.529-.026.287-.445.445-.287.026-.529L15 13l-.242-.471-.026-.529-.445-.287-.287-.445-.529-.026z" clip-rule="evenodd"/></svg> Ordens de serviço:</h3>
            <button type="button" class="btn btn-primary" onclick="window.location.href='addServico.php'">Nova</button>
            <button type="button" class="btn btn-warning" onclick="window.location.href='pdf.php'">Pdf</button>
            <br>
            <?php
                $r = $db->query("SELECT * FROM ordem ORDER BY dataRegistro DESC");
                $linhas = $r->fetchAll(PDO::FETCH_ASSOC);
                foreach($linhas as $l) {
                    echo "
                        <br>
                        <div class='list-group'>
                        <a href='readOrdem.php?id=".base64_encode($l['id'])."' class='list-group-item list-group-item-action' id='cardAtivo'>
                            <div class='d-flex w-100 justify-content-between'>
                                <h5 class='mb-1'>".$l['placaVeiculo']." - ".$l['cpfProprietario']."</h5>
                                <small class='text-muted'><span id='txtAmarelo'><strong>Cód: ".$l['dataRegistro']."</strong> | ".$l['dataRegistro']."</span></small>
                            </div>
                        </a>
                        </div>
                    ";
