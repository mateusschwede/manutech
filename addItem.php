<?php
    ...
    if((!empty($_POST['descricao'])) and (!empty($_POST['valor'])) and (!empty($_POST['cnpj']))) {
        ...
        <div class="col-sm-12">
            ...
            <form action="addItem.php" method="post">
                <div class="form-group">
                    <input type="text" class="form-control" name="descricao" placeholder="Descrição" maxlength="50">
                </div>
                <div class="form-group">
                    <input type="number" step="0.01" class="form-control" name="valor" placeholder="Valor(R$) 20.80" min=1 max=1000000>
                </div>
                <div class="form-group">
