        ...
        <div class="col-sm-12">
            ...
            <form action="addFornecedor.php" method="post">
                <div class="form-group">
                    <input type="number" class="form-control" required name="cnpj" placeholder="Cnpj" min=00000000000001 max=99999999999999 id="inputVerde">
                </div>
                <div class="form-group">
                    <input type="text" class="form-control" required name="nome" placeholder="Nome" maxlength="50" id="inputVerde">
                </div>
                <div class="form-group">
                    <input type="number" class="form-control" required name="telefone" placeholder="Telefone" min=1000000000 max=99999999999 id="inputVerde">
                </div>
                <div class="form-group">
                    <textarea class="form-control" required name="endereco" rows="3" placeholder="Endereço (rua x, nº 10, bairro y, cidade z - estado w, complemento xyz)" style="resize: none;" id="inputVerde"></textarea>
                </div>
